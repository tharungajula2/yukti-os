          ...
          <div className="relative overflow-hidden rounded-2xl border border-slate-200/60 bg-white/60 p-8 shadow-xl backdrop-blur-md">
            <div className="mb-8 text-center">
              ...
              <div className="mt-3 flex justify-center">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-slate-100 px-3 py-1 text-[10px] font-bold uppercase tracking-wide text-slate-500 border border-slate-200">
                  <span className="h-1.5 w-1.5 rounded-full bg-orange-400 animate-pulse" /> Work in Progress
                </span>
              </div>
            </div>
      ...
      <ToastProvider>
        ...
        <div className="md:hidden fixed top-0 left-0 right-0 h-16 bg-white/80 backdrop-blur-md border-b border-slate-200 z-40 flex items-center justify-between px-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-bold bg-slate-100 text-slate-500 px-1.5 py-0.5 rounded border border-slate-200">WIP</span>
          </div>
        ...
        <aside className={`fixed inset-y-0 left-0 z-50 w-64 border-r border-slate-200/60 bg-white shadow-2xl md:shadow-none transform transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 md:static md:inset-auto md:bg-white/60 md:backdrop-blur-md`}>
          ...
          <nav className="p-4 space-y-1">
            ...
            <NavItem
              ...
              label="Clinic Visits"
              isNew
              active={activeView === "clinic-hub"}
              onClick={() => setActiveView("clinic-hub")}
            />
            <NavItem
        ...
        <main className="flex-1 p-4 pt-20 md:p-8 overflow-x-hidden">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <p className="text-sm text-slate-600">
                  System operating at nominal capacity <span className="font-mono text-xs text-orange-600 bg-orange-50 px-1 rounded ml-1">(WIP v2.1)</span>
                </p>
              </div>
            </div>
            <HeaderIcons />
          ...
          {activeView === "dashboard" && (
            <div className="space-y-8">
              ...
              {/* 3. GRID: WHATSAPP + ACTIVITY FEED */}
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">

                {/* Left: WhatsApp Banner (Span 2) */}
                <div
                  onClick={() => setActiveView("whatsapp")}
                  className="lg:col-span-2 cursor-pointer bg-gradient-to-r from-[#25D366] to-[#128C7E] p-1 rounded-3xl shadow-lg shadow-green-100 transform hover:scale-[1.01] transition-all h-full"
                >
                  <div className="bg-white/10 backdrop-blur-sm p-6 rounded-[20px] flex flex-col md:flex-row items-center justify-between text-white h-full gap-4">
                    <div className="flex items-center gap-4">
                      <div className="h-12 w-12 bg-white rounded-full flex items-center justify-center text-[#128C7E] shrink-0">
                    ...
                    <div className="bg-white text-[#128C7E] px-4 py-2 rounded-xl font-bold text-sm shrink-0">
                      Activate Demo
                    </div>
                  </div>
                </div>

                {/* Right: Activity Feed (Span 1) */}
